...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2020 at 04:39 AM
...
INSERT INTO `company` (`company_id`, `company_name`, `company_address`, `country_id`, `state_id`, `district_id`, `company_statecode`, `company_pincode`, `company_mob1`, `company_mob2`, `company_email`, `company_website`, `company_pan_no`, `company_gst_no`, `company_cin_no`, `company_iec_no`, `company_logo`, `company_seal`, `date`) VALUES
(1, 'Property', 'Rajarampuri Kolhapur', 101, 22, 6, 27, '444555', '9876543210', '9998887770', 'demo@email.com', 'www.ppp.com', '111', '222', '3', '4', '', '', '2020-07-15 02:54:48');
...
CREATE TABLE `gst` (
  ...
  `gst_addedby` int(11) NOT NULL,
  `gst_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `gst` (`gst_id`, `company_id`, `gst_title`, `gst_rate`, `gst_status`, `gst_addedby`, `gst_created_at`) VALUES
(1, 1, '0% GST', 0, 1, 1, '2020-06-27 07:40:53'),
(2, 1, '5% GST', 5, 1, 1, '2020-06-27 07:40:55'),
(3, 1, '12% GST', 12, 1, 1, '2020-06-27 07:40:58'),
(4, 1, '18% GST', 18, 1, 1, '2020-06-27 07:40:49'),
(5, 1, '28% GST', 28, 1, 1, '2020-06-27 07:40:12');
...
CREATE TABLE `item` (
  ...
  `item_print_name` varchar(350) NOT NULL,
  `item_packing` varchar(350) NOT NULL,
  `item_code` varchar(350) NOT NULL,
  `item_hsn_code` varchar(350) NOT NULL,
  `item_tab_strip` double NOT NULL,
  `item_mrp` double NOT NULL,
  `item_price` double NOT NULL,
  `gst_id` int(11) NOT NULL,
  `item_min_level` varchar(100) NOT NULL,
  `item_max_level` varchar(100) NOT NULL,
  `item_reorder_level` varchar(100) NOT NULL,
  `item_schedule_h` int(11) NOT NULL,
  `item_schedule_h1` int(11) NOT NULL,
  `item_anti_tb` int(11) NOT NULL,
  `item_narcotics` int(11) NOT NULL,
  `item_image` varchar(150) NOT NULL,
  `item_status` int(11) NOT NULL DEFAULT 1,
  `item_addedby` int(11) NOT NULL,
  `item_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `item` (`item_id`, `company_id`, `main_category_id`, `sub_category_id`, `sub_category_two_id`, `item_name`, `item_print_name`, `item_packing`, `item_code`, `item_hsn_code`, `item_tab_strip`, `item_mrp`, `item_price`, `gst_id`, `item_min_level`, `item_max_level`, `item_reorder_level`, `item_schedule_h`, `item_schedule_h1`, `item_anti_tb`, `item_narcotics`, `item_image`, `item_status`, `item_addedby`, `item_created_at`) VALUES
(1, 1, 2, 2, 3, 'Demo Item', 'Demo Item-1', 'AAA', '111', '222', 10, 100, 90, 2, '10', '200', '20', 0, 0, 1, 0, 'item_1_1593331741.jpg', 1, 1, '2020-06-28 08:14:37');
...
CREATE TABLE `main_category` (
  ...
  `main_category_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `main_category` (`main_category_id`, `company_id`, `main_category_name`, `main_category_desc`, `main_category_image`, `main_category_status`, `main_category_addedby`, `main_category_created_at`) VALUES
(1, 1, 'Demo 1', 'sddsg sdfgsdfg', 'main_category_1_1593245592.jpg', 1, 1, '2020-06-27 08:13:12'),
(2, 1, 'Demo 2', 'des', 'main_category_2_1593252886.jpg', 1, 1, '2020-06-27 10:14:47');
...
CREATE TABLE `order_status` (
  ...
  `order_status_seq` int(11) NOT NULL,
  `order_status_status` int(11) NOT NULL DEFAULT 1,
  `order_status_addedby` int(11) DEFAULT NULL,
  `order_status_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `order_status` (`order_status_id`, `company_id`, `order_status_name`, `order_status_seq`, `order_status_status`, `order_status_addedby`, `order_status_created_at`) VALUES
(1, 1, 'Order Recieved', 1, 1, 1, '2020-06-28 02:19:13');
...
CREATE TABLE `pha_generic` (
  ...
  `generic_weight` double NOT NULL,
  `generic_disease` varchar(250) NOT NULL,
  `generic_how_to_use` varchar(250) NOT NULL,
  `generic_dose` varchar(250) NOT NULL,
  `generic_warning` varchar(250) NOT NULL,
  `generic_indication` varchar(250) NOT NULL,
  `generic_side_effect` varchar(250) NOT NULL,
  `generic_about` text NOT NULL,
  `generic_desc` text NOT NULL,
  `generic_disclaimer` text NOT NULL,
  `generic_name` varchar(250) NOT NULL,
  `generic_addedby` int(11) NOT NULL,
  `generic_status` int(11) DEFAULT 1,
  `generic_created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `generic_updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pha_product` (
  ...
  `product_ean` varchar(100) NOT NULL,
  `product_jan` varchar(100) NOT NULL,
  `product_isbn` varchar(100) NOT NULL,
  `product_mpn` varchar(100) NOT NULL,
  `product_location` varchar(100) NOT NULL,
  `product_quantity` int(11) NOT NULL,
  `stock_status_id` int(11) NOT NULL,
  `product_image` varchar(150) NOT NULL,
  `manufacturer_id` int(11) NOT NULL,
  `product_shipping` int(11) NOT NULL,
...
INSERT INTO `role` (`role_id`, `company_id`, `role_name`, `role_status`, `role_addedby`, `role_created_at`) VALUES
(1, 1, 'Admin', 1, 1, '0000-00-00 00:00:00'),
(2, 1, 'User', 1, 1, '2020-06-27 06:41:48');
...
CREATE TABLE `sub_category` (
  ...
  `sub_category_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sub_category` (`sub_category_id`, `company_id`, `main_category_id`, `sub_category_name`, `sub_category_desc`, `sub_category_image`, `sub_category_status`, `sub_category_addedby`, `sub_category_created_at`) VALUES
(2, 1, 2, 'Sub Demo 1', 'dfgdf sdfg sdfg', 'sub_category_2_1591875441.jpg', 1, 1, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `sub_category_two`
--
...
CREATE TABLE `sub_category_two` (
  ...
  `main_category_id` int(11) NOT NULL,
  `sub_category_id` int(11) NOT NULL,
  `sub_category_two_name` varchar(150) NOT NULL,
  `sub_category_two_desc` text NOT NULL,
  `sub_category_two_image` varchar(150) NOT NULL,
  `sub_category_two_status` int(11) NOT NULL DEFAULT 1,
  `sub_category_two_addedby` int(11) DEFAULT NULL,
  `sub_category_two_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sub_category_two`
--

INSERT INTO `sub_category_two` (`sub_category_two_id`, `company_id`, `main_category_id`, `sub_category_id`, `sub_category_two_name`, `sub_category_two_desc`, `sub_category_two_image`, `sub_category_two_status`, `sub_category_two_addedby`, `sub_category_two_created_at`) VALUES
(3, 1, 2, 2, 'Level 2 Demo', 'sadfsadf asdf', 'sub_category_two_3_1593316299.jpg', 1, 1, '2020-06-28 03:51:39');
...
CREATE TABLE `test_group` (
  ...
  `company_id` int(11) NOT NULL,
  `test_group_name` varchar(150) NOT NULL,
  `test_group_desc` text NOT NULL,
  `test_group_image` varchar(150) NOT NULL,
  `test_group_status` int(11) NOT NULL DEFAULT 1,
  `test_group_addedby` int(11) DEFAULT NULL,
  `test_group_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `test_group` (`test_group_id`, `company_id`, `test_group_name`, `test_group_desc`, `test_group_image`, `test_group_status`, `test_group_addedby`, `test_group_created_at`) VALUES
(1, 1, 'Demo Test Group', 'asdfasdf', 'test_group_1_1593336336.jpg', 1, 1, '2020-06-28 09:25:36');

-- --------------------------------------------------------

--
-- Table structure for table `test_subgroup`
--

CREATE TABLE `test_subgroup` (
  `test_subgroup_id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
  `test_group_id` int(11) NOT NULL,
  `test_subgroup_name` varchar(150) NOT NULL,
  `test_subgroup_desc` text NOT NULL,
  `test_subgroup_image` varchar(150) NOT NULL,
  `test_subgroup_status` int(11) NOT NULL DEFAULT 1,
  `test_subgroup_addedby` int(11) DEFAULT NULL,
  `test_subgroup_created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `test_subgroup`
--

INSERT INTO `test_subgroup` (`test_subgroup_id`, `company_id`, `test_group_id`, `test_subgroup_name`, `test_subgroup_desc`, `test_subgroup_image`, `test_subgroup_status`, `test_subgroup_addedby`, `test_subgroup_created_at`) VALUES
(2, 1, 1, 'Demo Subgroup1', 'dfgdfg', 'test_subgroup_2_1593336606.jpg', 1, 1, '2020-06-28 09:30:06');
...
INSERT INTO `unit` (`unit_id`, `company_id`, `unit_name`, `unit_status`, `unit_addedby`, `unit_created_at`) VALUES
(1, 1, 'Kg', 1, 1, '2020-06-27 07:02:57');
...
INSERT INTO `user` (`user_id`, `company_id`, `branch_id`, `role_id`, `user_name`, `user_lastname`, `user_city`, `user_email`, `user_mobile`, `user_mobile2`, `user_password`, `user_otp`, `user_website`, `user_dob`, `user_anniversary`, `user_pan`, `user_adhar`, `user_bank`, `user_acc_no`, `user_bank_ifsc`, `user_start_date`, `user_end_date`, `user_image`, `user_status`, `user_addedby`, `user_created_at`, `is_admin`) VALUES
(1, 1, '', 1, 'Admin', '', 'Kolhapur', 'demo@email.com', '9876543210', NULL, '123456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', 'Admin', '2020-06-27 05:50:44', 1),
(6, 1, '', 2, 'Datta Mane', '', 'Kolhapur', 'datta@mail.com', '9673454383', NULL, '123456', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '1', '2020-06-27 05:48:47', 0);
...
--
-- Indexes for table `pha_brand`
--
ALTER TABLE `pha_brand`
  ADD PRIMARY KEY (`brand_id`);

--
-- Indexes for table `pha_generic`
--
ALTER TABLE `pha_generic`
  ADD PRIMARY KEY (`generic_id`);

--
-- Indexes for table `pha_product`
--
ALTER TABLE `pha_product`
...
--
-- Indexes for table `sub_category_two`
--
ALTER TABLE `sub_category_two`
  ADD PRIMARY KEY (`sub_category_two_id`);
...
--
-- Indexes for table `test_subgroup`
--
ALTER TABLE `test_subgroup`
  ADD PRIMARY KEY (`test_subgroup_id`);
...
--
-- AUTO_INCREMENT for table `pha_brand`
--
ALTER TABLE `pha_brand`
  MODIFY `brand_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pha_generic`
--
ALTER TABLE `pha_generic`
  MODIFY `generic_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pha_product`
--
ALTER TABLE `pha_product`
...
--
-- AUTO_INCREMENT for table `sub_category_two`
--
ALTER TABLE `sub_category_two`
  MODIFY `sub_category_two_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `test_subgroup`
--
ALTER TABLE `test_subgroup`
  MODIFY `test_subgroup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
