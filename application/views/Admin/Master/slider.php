              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <?php if(!isset($update)){
                    ...
                    echo '<a href="'.base_url().'Master/slider" type="button" class="btn btn-sm btn-primary" >Add New</a>';
                  } ?>
                </div>
              </div>
              <!--  -->
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <!-- <div class="form-group col-md-12 ">
                        ...
                        <textarea class="form-control form-control-sm" name="slider_desc" id="slider_desc" rows="3" required><?php if(isset($slider_info)){ echo $slider_info['slider_desc']; } ?></textarea>
                      </div> -->
                      ...
                      <div class="form-group col-md-6">
                        <?php if(isset($slider_info) && $slider_info['slider_image']){ ?>
                          ...
                          <img width="200px" src="<?php echo base_url() ?>assets/images/website/<?php echo $slider_info['slider_image'];  ?>" alt="Slider Image">
                    ...
                    <div class="card-footer clearfix" style="display: block;">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                          <a href="<?php base_url(); ?>Master/slider" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                          <?php if(isset($update)){
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a target="_blank" href="<?php echo base_url() ?>assets/images/website/<?php echo $list->slider_image;?>"><?php echo $list->slider_image; ?></a></td>
                      <td>
